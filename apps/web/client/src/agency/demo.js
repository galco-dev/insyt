...
export const AGENCY_DEMO = {
  ...
  'POST /api/agency/drafts': {
    ok: true,
    draft: { id: 'd-new', account_id: 'a8', account: 'Cedar Kitchen', template: 'brand', status: 'draft', created_at: '2026-08-20T12:00:00Z', spec: { name: 'Brand — Cedar Kitchen (Insyt draft)', channel: 'search', budget_daily_usd: 8, bidding: 'Maximise conversions', conversion_goal: 'catering_enquiry', settings: { geo: 'Dubai', networks: ['search'], start_paused: true }, ad_groups: [{ name: 'Brand', keywords: [{ text: '"cedar kitchen"', match: 'phrase' }, { text: '[cedar kitchen]', match: 'exact' }], negatives: ['jobs', 'careers', 'salary'], rsa: { headlines: ['Cedar Kitchen — Official Site', 'Cedar Kitchen', 'Book Today', 'Trusted Local Choice', 'See Prices & Availability', 'Rated by Real Customers', 'Fast Response', 'Get In Touch Now'], descriptions: ['Cedar Kitchen — the official site.', 'Real reviews, clear prices, quick booking.', 'Questions? Reach us directly.', 'Book online in under a minute.'], pinned: { headline_1: 'Cedar Kitchen — Official Site' } } }], tracking_checks: ['conversion goal exists and fired in the last 14 days'] } },
  },
