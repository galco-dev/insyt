...
export const audit = {
  ...
  searchTerms: {
    ...
    rows: [
      ['russian manicure near me', 'Gel & Extensions', '$412', 188, 19, '$2.19', { v: 'promote', why: 'Your best search. Deserves its own ad + exact match.' }],
      ['gel extensions near me', 'Gel & Extensions', '$388', 176, 14, '$2.20', { v: 'keep', why: 'Booking steadily at $27.70 each. Leave it alone.' }],
      ['nail salon near me', 'Generic - Nails', '$356', 149, 8, '$2.39', { v: 'keep', why: 'Books at $44.50 - acceptable for a broad search.' }],
      ['biab nails', 'Gel & Extensions', '$247', 102, 9, '$2.42', { v: 'promote', why: 'Rising 3 months straight. Own ad group, exact match.' }],
      ['lash lift near me', 'Lashes', '$204', 96, 6, '$2.13', { v: 'keep', why: 'Steady. Watch after budget rebalance.' }],
      ['nail courses', 'Generic - Nails', '$231', 118, 0, '$1.96', { v: 'negative', why: 'Students, not clients. 118 clicks, zero bookings.' }],
      ['nail technician jobs', 'Generic - Nails', '$187', 94, 0, '$1.99', { v: 'negative', why: 'Job-seekers. Exclude “jobs”, “salary”, “vacancy”.' }],
      ['cheap nails near me', 'Generic - Nails', '$164', 88, 1, '$1.86', { v: 'negative', why: 'Bargain hunters, wrong price point. One booking in 90 days.' }],
      ...
      ['nail salon offers', 'Generic - Nails', '$97', 49, 1, '$1.98', { v: 'keep', why: 'Low but not zero. Re-judge after negatives clean the pool.' }],
      ['gel nails removal near me', 'Gel & Extensions', '$88', 42, 3, '$2.10', { v: 'keep', why: 'Removal clients often convert to new sets.' }],
      ['best nail salon near me', 'Generic - Nails', '$84', 38, 4, '$2.21', { v: 'promote', why: 'High-intent phrase booking at $21 - move to exact.' }],
    ],
  },
  ...
  keywords: {
    ...
    rows: [
      ...
      ['nails near me', 'broad', '$412', 6, '$68.70', '+122%', { v: 'rebid', why: 'Broad match is buying junk searches. Tighten to phrase, −30% bid.' }],
      ...
      ['manicure pedicure', 'phrase', '$142', 3, '$47.30', '+53%', { v: 'rebid', why: '−20% bid; re-check in 30 days.' }],
      ['nail art', 'phrase', '$121', 1, '$121.00', '+290%', { v: 'pause', why: 'One booking in 30 days at 4× your average. Pause, keep the history.' }],
    ...
    campaigns: [
      {
        ...
        budget: '$30/day',
        seed: 'Seeded from your 6 searches that already book under $30: russian manicure, biab nails, best nail salon near me + 3 more.',
